...
import { Briefcase, DollarSign, Users, TrendingUp, Check } from "lucide-react"
        ...
        <div>
          ...
          <section className="bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-700 dark:to-blue-900 text-white py-20 px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6 text-balance">Become a Worker</h1>
              <p className="text-xl text-blue-100 dark:text-blue-200 mb-8 max-w-2xl mx-auto text-pretty">
                Join our platform and start earning by offering your professional services to customers in your area
              </p>
          ...
          <section className="py-16 px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-12 text-foreground">Why Join WorkerDir?</h2>
          ...
          <section className="bg-card py-16 px-4 border-y">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8">
                {[
                  { step: 1, title: "Create Your Profile", description: "Tell us about your skills and experience" },
                  {
                    step: 2,
                    title: "Get Verified",
          ...
          <section className="py-16 px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8">Join thousands of workers earning on our platform</p>
        ...
        <div className="max-w-3xl mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium text-foreground">Step {step - 1} of 2</span>
              <span className="text-sm text-muted-foreground">{((step - 1) / 2) * 100}% Complete</span>
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>{step === 2 ? "Professional Information" : "Complete Your Profile"}</CardTitle>
            </CardHeader>
            <CardContent>
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        required
                      />
                      <p className="text-sm text-muted-foreground">Set your hourly rate. You can change this later.</p>
                    </div>
                  ...
                  <>
                    ...
                    <div className="flex items-start gap-2">
                      <Checkbox
                        ...
                        required
                      />
                      <Label htmlFor="terms" className="font-normal cursor-pointer leading-relaxed text-sm">
                        I agree to the Terms of Service and Privacy Policy. I understand that WorkerDir will verify my
