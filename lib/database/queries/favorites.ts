 ...
 */
export async function addFavorite(workerId: number): Promise<ApiResponse<Favorite>> {
  const userId = await getCurrentUserId()
 ...
 */
export async function removeFavorite(workerId: number): Promise<ApiResponse<boolean>> {
  const userId = await getCurrentUserId()
 ...
 */
export async function toggleFavorite(workerId: number): Promise<ApiResponse<boolean>> {
