 ...
 */
export async function getChatById(chatId: number): Promise<ApiResponse<ChatWithDetails>> {
 ...
 */
export async function markMessageAsRead(messageId: number): Promise<ApiResponse<Message>> {
  const supabase = getSupabaseClient()
 ...
 */
export async function markChatAsRead(chatId: number): Promise<ApiResponse<number>> {
  const userId = await getCurrentUserId()
 ...
 * Delete message
 */
export async function deleteMessage(messageId: number): Promise<ApiResponse<boolean>> {
  const supabase = getSupabaseClient()
