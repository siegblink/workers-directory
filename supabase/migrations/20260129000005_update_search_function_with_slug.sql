-- Update search_workers_by_location function to include slug in results
...
COMMENT ON FUNCTION search_workers_by_location IS 'Search workers by location with slug and updated foreign keys';
